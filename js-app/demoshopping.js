    ...
    function addToCart() {
        ...
        for (var index = 0; index < products.length; index++) {
            if (products[index].product_id == parseInt(selectedItem)) {
                idArray.push(products[index].product_id )
                productNameArray.push(products[index].product_name);
                productPriceArray.push(products[index].product_price);
                quantityArray.push(parseInt(quantityOfProduct));
